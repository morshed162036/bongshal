...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.category.create')->with(compact('catalogues','getCategories'));
    }
...
//                Image::make($image_temp)->resize(1040,1300)->save($imagePath);
    ...
    public function edit(string $id)
    {
        ...
        $catalogues = Catalogue::get()->all();
        return view('backend.category.edit')->with(compact('category','getCategories','catalogues'));
