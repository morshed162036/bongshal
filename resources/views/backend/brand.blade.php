            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Brand Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($brand) {{ route('brand',$brand->id) }} @else {{ route('brand') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            <h5>Brand Name <span class="star">*</span></h5>
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('brand') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                                        ...
                                        @if ($brands)
                                            @foreach ($brands as $brand)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('brand',$brand->id) }}">{{ $brand->name }}</a></td>
