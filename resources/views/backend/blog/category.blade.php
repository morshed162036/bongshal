...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Blog Section</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Categories Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($category) {{ route('blog-category',$category->id) }} @else {{ route('blog-category') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($category) {{ old('title',$category->title) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="slug" value="@if ($category) {{ old('slug',$category->slug) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="order" value="@if ($category) {{ old('order',$category->order) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($category)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('blog-category') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                                        ...
                                        @if ($categories)
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('blog-category',$category->id) }}">{{ $category->title }}</a></td>
