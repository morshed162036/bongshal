...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Vendor Create</h5>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('vendor.update',$vendor->id) }}" method="POST" enctype="multipart/form-data">  @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                        ...
                                        <img id="output">
                                        @if ($vendor->image)
                                            <img src="{{ asset($vendor->image) }}" alt="{{ $vendor->name }}" width='200'>
                                        @endif
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="name" value="{{ old('name',$vendor->name) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" aria-describedby="basic-Createon1" name="email" value="{{ old('email',$vendor->email) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="phone" value="{{ old('phone',$vendor->phone) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="wechat" value="{{ old('wechat',$vendor->wechat) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="address" value="{{ old('address',$vendor->address) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="website" value="{{ old('website',$vendor->website) }}">
                                            </div>
                                        </fieldset>
                                        ...
                                        {{-- <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-check-shield"></i></span>
                                                </div>
                                                <select class="form-control" name="status" aria-describedby="basic-Createon1">
