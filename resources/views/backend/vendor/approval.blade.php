                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">New Vendor List</h5>
                                            ...
                                            @if ($vendors)
                                                @foreach ($vendors as $vendor)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($vendor->status == 'cancel')
                                                                <a class="" id="product_type-{{ $vendor->id }}"
                                                        ...
                                                        <td>
                                                            <a href="{{ route('approveVendor',$vendor->id) }}" class="btn btn-success btn-sm">Approve</a>
                                                            <a href="{{ route('rejectVendor',$vendor->id) }}" class="btn btn-danger btn-sm">Reject</a>
                                                        </td>
                                                        {{-- <td>
                                                            <div class="dropdown">
