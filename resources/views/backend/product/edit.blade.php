                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                    <label for="catalogue_id"></label>
                                    <select name="catalogue_id" id="catalogue_id" class="form-control" hidden>
                                        <option value="">Select Catalogue</option>
                                        @foreach ($catalogues as $catalogue)
                                            <option value="{{ $catalogue->id }}" @if ($product->category->catalogue_id == $catalogue->id)
                                                selected
                                            @endif>{{ $catalogue->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            <div class="row">
                                ...
                                <div class="col-md-6" id="fitment-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="bike_id" id="bike_id" class="form-control" required>
                                            ...
                                            <option value="0" @if($product->bike_id == 0) selected @endif >Universal</option>
                                            @foreach($bikes as $bike)
                                                <option value="{{ $bike->id }}" @if ($product->bike_id == $bike->id) selected
                                                @endif>{{ $bike->model }} ({{ $bike->company->name }})</option>
                                            @endforeach
                                        </select>
                                        @error('bike_id')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6" id="series-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="series" class="form-control" id="series" placeholder="(e.g. G-TX Series etc)" value="{{ old('series',$product->series) }}">
                                        @error('series')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6" id="traditional-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="traditional_name" class="form-control" id="traditional_name" placeholder="(e.g. Rear Suspension etc)" value="{{ old('traditional_name',$product->traditional_name) }}" required>
                                ...
                                <div class="col-md-6" id="commercial-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="commercial_name" class="form-control" id="commercial_name" placeholder="(e.g. CUSHION ASSY, REAR etc)" value="{{ old('commercial_name',$product->commercial_name) }}" required>
                                ...
                                <div class="col-md-6" id="partnumber-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="part_number" class="form-control" id="part_number" placeholder="(e.g. 123-322-1212)" value="{{ old('part_number',$product->part_number) }}">
                                        @error('part_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="unit-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit" class="form-control" id="unit" placeholder="Enter Unit (e.g. KG, Pc etc)" value="{{ old('unit',$product->unit) }}" required>
                                        @error('unit')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="grade-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="grade" class="form-control" id="grade" placeholder="Enter Grade" value="{{ old('grade',$product->grade) }}">
                                        @error('grade')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="engine_oil-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="engine_oil_type" id="engine_oil_type" class="form-control">
                                            ...
                                            <option value="Mineral" {{ old('engine_oil_type',$product->engine_oil_type) == 'Mineral' ? 'selected' : '' }}>Mineral</option>
                                            <option value="Semi Synthetic" {{ old('engine_oil_type',$product->engine_oil_type) == 'Semi Synthetic' ? 'selected' : '' }}>Semi Synthetic</option>
                                            <option value="Fully Synthetic" {{ old('engine_oil_type',$product->engine_oil_type) == 'Fully Synthetic' ? 'selected' : '' }}>Fully Synthetic</option>
                                        </select>
                                ...
                                <div class="col-md-6" id="quantity-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="quantity" class="form-control" id="quantity" placeholder="Enter Quantity" value="{{ old('quantity',$product->quantity) }}">
                                        @error('quantity')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div id="tyre-row" style="display:none;">
                                    ...
                                    <div class="col-md-4" id="width-div" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="width" class="form-control" id="width" placeholder="Enter Width" value="{{ old('width',$product->width) }}">
                                            @error('width')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4" id="aspectratio-div" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="aspectratio" class="form-control" id="aspectratio" placeholder="Enter Aspectratio" value="{{ old('aspectratio',$product->aspect_ratio) }}" >
                                            @error('aspectratio')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4" id="rim-div" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rim" class="form-control" id="rim" placeholder="Enter Rim Size" value="{{ old('rim',$product->rim) }}" >
                                            @error('rim')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" id="barcode-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="barcode" class="form-control" id="barcode" placeholder="Enter barcode" value="{{ old('barcode',$product->barcode) }}">
                                        @error('barcode')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="min_purchase_qty-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="min_purchase_qty" class="form-control" id="min_purchase_qty" placeholder="Enter Minimum Purchase Quantity" value="{{ old('min_purchase_qty',$product->min_purchase_qty) }}">
                    ...
                    <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    @if($product->image)
                                        <img src="{{ asset('images/products/image/'.$product->image) }}"
                                            alt="Product Image" width="120" class="mt-2">
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    @if($product->images)
                                        <div class="row">
                                            @foreach($product->images as $image)
                                                <div class="col-md-3">
                                                    <img src="{{ asset('images/products/multi/'.$image->image) }}"
                                                        alt="Product Multi Image" width="100" class="mt-2">
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                                                ...
                                                <div class="row justify-content-between" id="product_details">
                                                        ...
                                                        <select name="attribute_id" class="form-control attribute-select">
                                                            @foreach($attributes as $attribute)
                                                                <option value="{{ $attribute->id }}"
                                                                    {{ $attr->attribute->id == $attribute->id ? 'selected' : '' }}>
                                                                    {{ $attribute->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 form-group value-col">
                                                        ...
                                                        <select name="attribute_value_id" class="form-control value-select">
                                                            @foreach($attributes as $attribute)
                                                                @if ($attribute->id == $attr->attribute->id)
                                                                    @foreach ($attribute->values as $value)
                                                                    <option value="{{ $value->id }}"
                                                                        {{ $value->id == $attr->attributeValue->id ? 'selected' : '' }}>
                                                                        {{ $value->name }}
                                                                    </option>
                            ...
                            <div class="row">
                                <div class="col-md-6" id="unit_price-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="unit_price" class="form-control" id="unit_price" placeholder="0" value="{{ old('unit_price',$product->unit_price) }}" required>
                                        @error('unit_price')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="purchase_price-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="purchase_price" class="form-control" id="purchase_price" placeholder="0" value="{{ old('purchase_price',$product->purchase_price) }}">
                                ...
                                <div class="col-md-6" id="discount_start-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_date" class="form-control" id="start_date" placeholder="0" value="{{ old('start_date',$product->start_date) }}">
                                        @error('start_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="discount_end-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_date" class="form-control" id="end_date" placeholder="0" value="{{ old('end_date',$product->end_date) }}">
                                        @error('end_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="discount-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="discount" class="form-control" id="discount" placeholder="0" value="{{ old('discount',$product->discount) }}">
                                        @error('discount')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="stock_quantity-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stock_quantity" class="form-control" id="stock_quantity" placeholder="0" value="{{ old('stock_quantity',$product->stock_quantity) }}">
                                ...
                                <div class="col-md-6" id="alert_quantity-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="alert_quantity" class="form-control" id="alert_quantity" placeholder="0" value="{{ old('alert_quantity',$product->alert_quantity) }}">
                                ...
                                <div class="col-md-6" id="weight-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="weight" class="form-control" id="weight" placeholder="Enter Weight" value="{{ old('weight',$product->weight) }}">
                                        @error('weight')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="sku-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sku" class="form-control" id="sku" placeholder="Enter SKU" value="{{ old('sku',$product->sku) }}">
                                        @error('sku')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row" id="description-div" style="display:none;">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="content" class="form-control" rows="4">{{ old('description',$product->description) }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="oem-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="is_oem" id="is_oem" class="form-control">
                                            ...
                                            <option value="yes" {{ old('is_oem',$product->is_oem) == 'yes' ? 'selected' : '' }}>Yes</option>
                                            <option value="no" {{ old('is_oem',$product->is_oem) == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('is_oem')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6" id="preorder-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="is_preorder" id="is_preorder" class="form-control">
                                            <option value="">Select Option</option>
                                            <option value="yes" {{ old('is_preorder',$product->is_preorder) == 'yes' ? 'selected' : '' }}>Yes</option>
                                            <option value="no" {{ old('is_preorder',$product->is_preorder) == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('is_preorder')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6" id="shipping_time-div" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_time" class="form-control" id="shipping_time" placeholder="Enter Shipping Time" value="{{ old('shipping_time',$product->shipping_time) }}">
                                        @error('shipping_time')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_description" class="form-control" id="meta_description" placeholder="Enter meta description" value="{{ old('meta_description',$product->meta_description) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords" class="form-control" id="meta_keywords" placeholder="Enter meta keywords" value="{{ old('meta_keywords',$product->meta_keywords) }}">
                                        @error('meta_keywords')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($product->meta_image)
                                        <img src="{{ asset('images/products/meta/'.$product->meta_image) }}"
                                            alt="Meta Image" width="120" class="mt-2">
                                    @endif
                                </div>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // console.log(catalogueSelect.value);
        ...
        const catalogueId = catalogueSelect.value;
            ...
            fetch("{{ url('/get-categories-subcategories') }}"+ "/" +catalogueId)
                ...
                .then(data => {
                    data.forEach(cat => {
                        ...
                        categorySelect.innerHTML += `<option value="${cat.id}" ${isSelected}>${cat.name}</option>`;

                        // Add subcategories (indented visually)
                        if (cat.subcategories && cat.subcategories.length > 0) {
                            cat.subcategories.forEach(sub => {

                            const isSelected = sub.id == selectedCategoryId ? 'selected' : '';
                            categorySelect.innerHTML += `<option value="${sub.id}" ${isSelected}>— ${sub.name}</option>`;
                            });
                        }
                    });
                });
