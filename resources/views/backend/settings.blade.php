                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <img src="{{ asset('images/setting/'.$company->logo) }}" id="logo" alt="logo" width="300px" height="100px" class="mt-2 mx-1">
                                        @endif
                                        <fieldset class="mt-2">
                                            <h5>Favicon</h5>
                                            <div class="input-group">
                                        ...
                                        <img src="{{ asset('images/setting/'.$company->favicon) }}" id="favicon" alt="favicon" width="100px" height="100px" class="mt-2 mx-1">
                                        @endif
                                        <fieldset class="mt-2">
                                            <h5>SOS Banner</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="file" class="form-control" aria-describedby="basic-Createon1" name="sos_banner" onchange="loadBanner(event)">
                                            </div>
                                        </fieldset>
                                        @if($company->sos_banner != null)
                                        <img src="{{ asset('images/setting/'.$company->sos_banner) }}" id="sos_banner" alt="sos_banner" width="500px" height="150px" class="mt-2 mx-1">
                                        @endif
                                        {{-- <img > --}}
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="site_name" class="form-control" @if ($company->site_name)
                                        ...
                                        <fieldset class="mt-2">
                                            <h5>Whatsapp <span class="star">*</span></h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-spreadsheet"></i></span>
                                                </div>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="short_about">{{ $company->short_about }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Copyright</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="copyright">{{ $company->copyright }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Meta Tag</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="text" name="meta_tag">{{ $company->meta_tag }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Meta Keywords</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="text" name="meta_keyword">{{ $company->meta_keyword }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="meta_description">{{ $company->meta_description }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="google_analytics_code">{{ $company->google_analytics_code }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="facebook_pixel_code">{{ $company->facebook_pixel_code }}</textarea>
                                            </div>
                                        </fieldset>
...
@section('js')
    ...
    <script>
        ...
        var loadBanner = function(event) {
            var sos_banner = document.getElementById('sos_banner');
            sos_banner.src = URL.createObjectURL(event.target.files[0]);
            sos_banner.height =  '100';
        }
    </script>
@endsection
