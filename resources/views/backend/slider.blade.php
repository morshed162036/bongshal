            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Slider Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($slider) {{ route('slider',$slider->id) }} @else {{ route('slider') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($slider) {{ old('title',$slider->title) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="subtitle" value="@if ($slider) {{ old('subtitle',$slider->subtitle) }}@endif">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="order" value="@if ($slider) {{ old('order',$slider->order) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="url" value="@if ($slider) {{ old('url',$slider->url) }}@endif">
                                            </div>
                                        </fieldset>
                                    </div>
                                    {{-- <div class="col-md-6 mt-2">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <fieldset>
                                            <h5>Photo <span class="star">*</span></h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-file"></i></span>
                                                </div>
                                        ...
                                        @if ($slider)
                                            @if($slider->photo != null)
                                                <img src="{{ asset('images/slider/'.$slider->photo) }}" id="bg" alt="bg" width="200px" height="200px" class="mt-2 mx-1">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($slider)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('slider') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                                    ...
                                    <tbody>
                                        @if ($sliders)
                                            @foreach ($sliders as $slider)
                                                <tr>
                                                    <td class="text-bold-600" ><img src="{{ asset('images/slider/'.$slider->photo) }}" alt="" height="150px"></td>
                                                    <td><a href="{{ route('slider',$slider->id) }}">{{ $slider->title }}</a></td>
                                                    <td>
                                                        {{ $slider->subtitle }}
                                                    </td>
                                                    <td>{{ $slider->url }}</td>
