        ...
        <section class="component component--visual-category-links visual-category-links"
            ...
            <div class="component__content">
                <div class="visual-category-links__content visual-category-links__content--full-width">
                    <div class="visual-category-links__header ui-h1" data-heading="Featured Categories">
                        Featured Categories
                    </div>
                    ...
                    <div class="visual-category-links__row">
                        ...
                        <a class="visual-category-links__link @if ($loop->odd) visual-category-links__link--odd @endif"
                            ...
                            data-asset-name="{{ $catalogue->name }}" data-asset-type="Visual Category Link"
                            data-asset-id="{{ $catalogue->id }}" data-position="{{ $loop->index }}">
                            <img src="{{ asset('images/category/'.$catalogue->image) }}" alt="{{ $catalogue->name }}"
...
<<<<<<< HEAD
                        ...
                        <a href="{{ $promotion->url }}" class="dynaboard__board"
                            data-analytics-asset-link="{{ $promotion->url }}" data-analytics-asset-type="Dynaboard">
                            ...
                            {{-- Image --}}
                            <img alt="{{ $promotion->title }} - {{ $promotion->description_short }}"
                                class="dynaboard__board-image"
                                src="{{ asset('images/promotions/' . $promotion->image) }}"
                                onerror="this.onerror=null;this.src='https://placehold.co/600x360/E5E7EB/4B5563?text=Image+Missing'"
                                style="aspect-ratio: 1.67464114832536">

                            {{-- Content --}}
                            <div class="dynaboard__board-content">
                                <div>
                                    <div class="dynaboard__board-heading">
                                        {{ $promotion->title }}
                                    </div>
                                    <div class="dynaboard__board-subheading">
                                        {{ $promotion->description_short }}
                                    </div>
                                </div>
                        ...
                        @endforeach
                        @else
                        <p>No product promotions are currently active.</p>
                        @endif
=======
            @foreach($promotions as $promotion)
                <a href="{{ $promotion->url }}"
                   class="dynaboard__board"
                   data-analytics-asset-link="{{ $promotion->url }}"
...
>>>>>>> 4c182987ded501b02deec36616d630990b82571f
    ...
    <div class="component__wrapper">
        <section class="component component--top-brands top-brands" data-analytics-component-id="173807"
            data-analytics-component-type="TopBrands" data-component-type="Top Brands" data-js-component="TopBrands"
            data-js-scheduled-component-id="173807">
            <div class="component__content">
...
<<<<<<< HEAD
                    ...
                    <a href="{{ $brand->details ?? '#' }}" class="top-brands__brand-link"
                        data-asset-name="{{ $brand->name }}" data-asset-type="Top Brand"
                        data-asset-id="{{ $brand->id ?? '' }}" data-link="{{ $brand->details ?? '#' }}">

                        <img src="{{ asset('images/brand/' . ($brand->logo ?? 'default.svg')) }}"
                            alt="{{ $brand->name }}" class="top-brands__brand-logo"
...
<div class="component__wrapper">
    <section class="component component--tabbed-product-tray tabbed-product-tray" data-analytics-component-id="173712"
        data-analytics-component-type="TabbedProductTray" data-component-type="Tabbed Product Tray"
        data-js-component="TabbedProductTray" data-js-scheduled-component-id="173712">
        <div class="component__content">
                                ...
                                <div class="related-products__scroll-wrapper tray__scroll-wrapper">
                                    <div class="related-products__product-tile-wrapper" data-js="ProductTile.wrapper">
                                        <a class="related-products__product-tile product-tile" data-index="0"
                                            ...
                                            <div class="badge badge--vertical">
                                                <div class="badge__message badge__message--staff-picks-2019">Staff
                                                    Pick
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-tile__price-retail--sale product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>395<sup
                                                    ...
                                                    <div class="product-tile__details product-tile__details--swatches">
                                                        <ul class="product-tile__swatches">
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    ...
                                                                    data-js-option-id="24"
                                                                    style="background-color: Black"
                                                                    title="Black"></span></li>
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    class="product-tile__swatch js-ProductImageCrossfader-swatch-988414"
                                                                    data-js-option-id="144"
                                                                    style="background-color: Silver"
                                                                    title="Silver"></span></li>
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    class="product-tile__swatch js-ProductImageCrossfader-swatch-988414"
                                                                    data-js-option-id="57"
                                                                    style="background-color: Blue" title="Blue"></span>
                                                            </li>
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    class="product-tile__swatch js-ProductImageCrossfader-swatch-988414"
                                                                    ...
                                                                    class="product-tile__swatch-more-count">+1</span>
                                                            </li>
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    class="product-tile__swatch js-ProductImageCrossfader-swatch-988414"
                                                                    data-js-option-id="8599"
                                                                    style="background-color: brown"
                                                                    title="Tarmac"></span><span
                                                                    class="product-tile__swatch-more-count">+0</span>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>199<sup
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>79<sup
                                        ...
                                        <a class="related-products__product-tile product-tile" data-index="3"
                                            ...
                                            <div class="product-tile__content">
                                                <div class="product-tile__image-container"><img
                                                        ...
                                                        width="480"></div>
                                                <div class="product-tile__summary">
                                                    <div class="product-tile__name" data-qa="product-tile-name">AGV
                                                        K6 S
                                                        Erazer Helmet</div>
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>699<sup
                                    ...
                                    <div class="related-products__product-tile-wrapper" data-js="ProductTile.wrapper">
                                        <a class="related-products__product-tile product-tile" data-index="4"
                                            ...
                                            <div class="badge badge--vertical">
                                                <div class="badge__message badge__message--top-rated">Top Rated
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-tile__price-retail--sale product-details__price-retail mny__rng"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>202<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>309<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span></span><span
                                    ...
                                    <div class="related-products__product-tile-wrapper" data-js="ProductTile.wrapper">
                                        <a class="related-products__product-tile product-tile" data-index="5"
                                            ...
                                            <div class="product-tile__content">
                                                <div class="product-tile__image-container"><img
                                                        alt="Icon Airform Scatterbrain Helmet"
                                                        class="product-tile__image"
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>250<sup
                                                                            class="mny__s">.</sup><sup>00</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-tile__price-retail--sale product-details__price-retail mny__rng"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>599<sup
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>329<sup
                                                                            class="mny__s">.</sup><sup>95</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>739<sup
                                                                            class="mny__s">.</sup><sup>00</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>14<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail mny__rng"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>249<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>269<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    <div class="product-tile__details product-tile__details--swatches">
                                                        <ul class="product-tile__swatches">
                                                            ...
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    ...
                                                                    class="product-tile__swatch-more-count">+2</span>
                                                            </li>
                                                            <li class="product-tile__swatch-wrapper"><span
                                                                    class="product-tile__swatch js-ProductImageCrossfader-swatch-858123"
                                                                    data-js-option-id="82"
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail mny__rng"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>649<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>729<sup
                                                                            class="mny__s">.</sup><sup>99</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-tile__price-retail--sale product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>359<sup
                                                                            class="mny__s">.</sup><sup>00</sup><span
                                                                            class="mny__c"></span></span></span></span><span
                                                                class="product-tile__price-was product-details__price-was "><span
                                                                    data-js="Money.parsedMoney"><span
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>724<sup
                                                                            class="mny__s">.</sup><sup>95</sup><span
                                                                            class="mny__c"></span></span></span></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-tile__summary">
                                                    ...
                                                    <div class="product-tile__pricing">
                                                        ...
                                                        <div class="product-tile__prices"><span
                                                                class="product-tile__price-retail product-tile__price-retail--sale product-details__price-retail"><span
                                                                    data-js="Money.stylizedMoney"><span
                                                                        class="mny"><span class="mny__c">$</span>449<sup
                                                                            class="mny__s">.</sup><sup>95</sup><span
                                                                            class="mny__c"></span></span></span></span><span
                                                                class="product-tile__price-was product-details__price-was "><span
                                                                    data-js="Money.parsedMoney"><span
                                    ...
                                    <div class="related-products__scroll-wrapper tray__scroll-wrapper">
                                        <div class="related-products__product-tile-wrapper"
                                            ...
                                            <a class="related-products__product-tile product-tile" data-index="0"
                                                ...
                                                <div class="product-tile__content">
                                                    <div class="product-tile__image-container"><img
                                                            alt="Cardo PackTalk Edge Headset"
                                                            class="product-tile__image"
                                                            src="https://www.revzilla.com/cdn-cgi/image/onerror=redirect,format=auto,q=75,w=642/asset_instance_attachments/86764/86764_1753375047_desktop_2x.jpg"
                                                            height="480" id="js-ProductImageCrossfader-image-969982"
                                                            width="480"></div>
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            ...
                                            <a class="related-products__product-tile product-tile" data-index="1"
                                                ...
                                                <div class="product-tile__content">
                                                    ...
                                                    <div class="product-tile__summary">
                                                        <div
                                                            class="product-tile__details product-tile__details--swatches">
                                                            <ul class="product-tile__swatches">
                                                                <li class="product-tile__swatch-wrapper"><span
                                                                        class="product-tile__swatch js-ProductImageCrossfader-swatch-988414"
                                                                        data-js-option-id="24"
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            ...
                                            <a class="related-products__product-tile product-tile" data-index="5"
                                                ...
                                                <div class="product-tile__sash product-tile__sash--new">
                                                    <div
                                                        class="product-tile__sash-message product-tile__sash-message--new">
                                                        New</div>
                                                </div>
                                                <meta content="Icon Airform Scatterbrain Helmet" itemprop="name">
                                                <meta content="Icon" itemprop="brand">
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            data-js="ProductTile.wrapper">
                                            <a class="related-products__product-tile product-tile" data-index="8"
                                                data-js="ProductTile.link" data-product-id="1129431"
                                                data-skus="10474862"
                                                href="/motorcycle/rabaconda-street-bike-tire-changer" itemprop="url"
                                                title="Rabaconda Street Bike Tire Changer">
                                                <meta content="Rabaconda Street Bike Tire Changer" itemprop="name">
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            data-js="ProductTile.wrapper">
                                            <a class="related-products__product-tile product-tile" data-index="9"
                                                data-js="ProductTile.link" data-product-id="1113595"
                                                data-skus="10445475"
                                                href="/motorcycle/stockton-x-adams-all-purpose-cleaner" itemprop="url"
                                                title="Stockton X Adam&#39;s All Purpose Cleaner">
                                                <div class="product-tile__sash product-tile__sash--new">
                                                ...
                                                <meta content="Stockton X Adam&#39;s All Purpose Cleaner"
                                                    itemprop="name">
                                                <meta content="Stockton Tools" itemprop="brand">
                                                <meta content="1113595" itemprop="productId">
                                                <meta
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            ...
                                            <a class="related-products__product-tile product-tile" data-index="10"
                                                ...
                                                <div class="product-tile__content">
                                                    <div class="product-tile__image-container"><img
                                                            alt="Klim Dakar Pants" class="product-tile__image"
                                                            src="https://www.revzilla.com/product_images/1511/7322/klim_dakar_pants_monument_gray_480x480.jpg"
                                                            height="480" id="js-ProductImageCrossfader-image-891242"
                                                            width="480"></div>
                                                    <div class="product-tile__summary">
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            ...
                                            <a class="related-products__product-tile product-tile" data-index="12"
                                                ...
                                                <div class="product-tile__content">
                                                    <div class="product-tile__image-container"><img
                                                            alt="Dainese Tempest 3 D-Dry Jacket"
                                                            class="product-tile__image"
                                                            src="https://www.revzilla.com/product_images/1704/1021/dainese_tempest3_d_dry_jacket_black_red_480x480.jpg"
                                                            height="480" id="js-ProductImageCrossfader-image-905402"
                                                            width="480"></div>
                                        ...
                                        <div class="related-products__product-tile-wrapper"
                                            data-js="ProductTile.wrapper">
                                            <a class="related-products__product-tile product-tile" data-index="14"
                                                data-js="ProductTile.link" data-product-id="1094947"
                                                data-skus="10399358" href="/motorcycle/cardo-packtalk-pro-headset"
                                                itemprop="url" title="Cardo PackTalk Pro Headset">
                                                <meta content="Cardo PackTalk Pro Headset" itemprop="name">
                                                <meta content="Cardo Systems" itemprop="brand">
                                                <meta content="1094947" itemprop="productId">
                                                <meta
            ...
            <div class="category-preview__tray tray">
                <div class="category-preview__scroll-overflow-wrapper tray__scroll-overflow-wrapper">
                    <div class="category-preview__scroll-wrapper tray__scroll-wrapper category-preview__tiles">
                        <div class="category-preview__miniboard category-preview__miniboard--desktop miniboard--dynamic-height"
                            data-asset-id="86021" data-asset-name="" data-asset-type="Miniboard">
                            @if (isset($sideBannerAd) && $sideBannerAd)
                            <a class="category-preview__board miniboard__board ui-cta-button-wrapper"
                                data-link="{{ $sideBannerAd->url }}" href="{{ $sideBannerAd->url }}">
                                <div class="miniboard__image-header">
                                    <div class="miniboard__header">
                                        <div class="miniboard__title">
                                            {{-- Use 'title' field for the main heading --}}
                                            <span class="miniboard__heading" data-heading="">

                                            </span>
                                        </div>
                                        {{-- Use 'image_1' field for the main banner image --}}
                                        <img alt="{{ $sideBannerAd->title }}" class="miniboard__image"
                                            src="{{ asset($sideBannerAd->image_1) }}"
                                            onerror="this.onerror=null;this.src='https://placehold.co/642x400/CCCCCC/333333?text=Ad+Image'">
                                    </div>
                                </div>
                                <div class="miniboard__body">
                                    {{-- Use 'subtitle' field for the copy --}}
                                    <span class="miniboard__copy" data-subcopy="{{ $sideBannerAd->title }}">
                                        {{ $sideBannerAd->title }}
                                    </span>
                                    <span class="miniboard__button">
                                        <span class="ui-button ui-button--small" data-call-to-action=".">Shop Now</span>
                                    </span>
                                </div>
                            </a>
                            @endif
                        ...
                        <div class="category-preview__product-tile-wrapper" data-js="ProductTile.wrapper">
                            <a class="category-preview__product-tile product-tile" data-index="3"
                                ...
                                <meta
                                    ...
                                    itemprop="image">
                                <div class="product-tile__content">
                                    <div class="product-tile__image-container"><img alt="Alpinestars Ramjet Air Pants"
                                            class="product-tile__image"
                                            src="https://www.revzilla.com/product_images/0268/0254/alpinestars_pant_ramjet_black_480x480.jpg"
                                            height="480" id="js-ProductImageCrossfader-image-367788" width="480">
                                    </div>
                                    <div class="product-tile__summary">
                                        ...
                                        <div class="product-tile__rating">
                                            ...
                                            <span class="product-tile__rating-stars product-rating__stars"
                                                data-js="ReviewInterface.ratingStars" data-rating="3.5"></span>
                                            <span class="product-tile__rating-count product-rating__count">51</span><img
                            ...
                            <a class="category-preview__product-tile product-tile" data-index="4"
                                ...
                                <div class="product-tile__content">
                                    <div class="product-tile__image-container"><img
                                            ...
                                            height="480" id="js-ProductImageCrossfader-image-362711" width="480">
                                    </div>
                                    <div class="product-tile__summary">
                                        <div class="product-tile__details product-tile__details--swatches">
                                            <ul class="product-tile__swatches">
                            ...
                            <a class="category-preview__product-tile product-tile" data-index="5"
                                ...
                                <div class="product-tile__content">
                                    <div class="product-tile__image-container"><img alt="Klim Induction Jacket"
                                            ...
                                            height="480" id="js-ProductImageCrossfader-image-892114" width="480">
                                    </div>
                                    <div class="product-tile__summary">
                                        <div class="product-tile__details product-tile__details--swatches">
                                            <ul class="product-tile__swatches">
                            ...
                            <a class="category-preview__product-tile product-tile" data-index="6"
                                ...
                                <div class="product-tile__content">
                                    <div class="product-tile__image-container"><img alt="BILT Techno 2 Jacket"
                                            ...
                                            height="480" id="js-ProductImageCrossfader-image-915743" width="480">
                                    </div>
                                    <div class="product-tile__summary">
                                        <div class="product-tile__details product-tile__details--swatches">
                                            <ul class="product-tile__swatches">
                                            ...
                                            <div class="product-tile__savings">
                                                <label
                                                    ...
                                                    <div class="product-tile__clp-savings-txt"><span
                                                            class="product-tile__clp-savings-mem">Members</span>
                                                        <span class="product-tile__clp-savings-sav">save</span>
                                                        <span class="product-tile__clp-savings-per">10%</span></div>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="product-tile__shipping-callout">
                                        ...
                                        <div class="product-tile__rating">
                                            ...
                                            <span class="product-tile__rating-stars product-rating__stars"
                                                data-js="ReviewInterface.ratingStars" data-rating="4.5"></span>
                                            <span
...
@if (isset($mainBannerAd) && $mainBannerAd)
<div class="component__wrapper component__wrapper--background-white">
    <section class="component component--bannerboard bannerboard" data-analytics-component-id="{{ $mainBannerAd->id }}"
        data-analytics-component-type="Bannerboard" data-js-component="Bannerboard"
        data-js-scheduled-component-id="{{ $mainBannerAd->id }}">
        <div class="component__content">
            <div class="bannerboard__wrapper">
                <div class="bannerboard__board bannerboard__board--short bannerboard__board--mobile-left"
                    data-analytics-asset-id="{{ $mainBannerAd->id }}" data-analytics-asset-type="BannerboardShort"
                    data-analytics-asset-position="0">

                    <a data-analytics-asset-link="{{ $mainBannerAd->url }}" href="{{ $mainBannerAd->url }}"
                        target="_blank">

                        {{-- Image is fetched from the model's image_1 column --}}
                        <img alt="{{ $mainBannerAd->title ?? 'Main Ad Banner' }}" class="bannerboard__image"
                            src="{{ asset($mainBannerAd->image_1) }}"
                            onerror="this.onerror=null;this.src='https://placehold.co/1000x300/CCCCCC/333333?text=Main+Banner+Ad'">
                    </a>
                </div>
            </div>
        </div>
...
<div class="component__wrapper component__wrapper--background-white">
    <section class="component component--trioboard trioboard" data-analytics-component-id="173832"
        data-analytics-component-type="Trioboard" data-js-component="Trioboard" data-js-scheduled-component-id="173832"
        data-js-scrollable="true">
        <div class="component__content">
            <div class="js-CmtoTray" id="Trioboard-173832">
                <div class="js-CmtoTray-controlWrapper">
                    <div class="js-CmtoTray-scrollWrapper">
                        <div class="trioboard__board trioboard__board--TrioboardTall " data-analytics-asset-id="86705"
                            data-analytics-asset-position="0" data-analytics-asset-type="TrioboardTall"><a
                        ...
                        <div class="trioboard__board trioboard__board--TrioboardTall " data-analytics-asset-id="86483"
                            data-analytics-asset-position="1" data-analytics-asset-type="TrioboardTall"><a
                                data-analytics-asset-link="/rpm" href="/rpm"><img
                                    alt="All Inclusive Moto Adventure For RPM Members - Join Now"
                        ...
                        <div class="trioboard__board trioboard__board--TrioboardTall " data-analytics-asset-id="83492"
                            data-analytics-asset-position="2" data-analytics-asset-type="TrioboardTall"><a
...
@if (isset($tripleBannerAd) && $tripleBannerAd)
<div class="component__wrapper component__wrapper--background-white">
    <section class="component component--bannerboard bannerboard"
        data-analytics-component-id="{{ $tripleBannerAd->id }}" data-analytics-component-type="BannerboardTriple"
        data-js-component="Bannerboard" data-js-scheduled-component-id="{{ $tripleBannerAd->id }}">

        <div class="component__content">
            @if ($tripleBannerAd->title)
            <h2 class="bannerboard__section-title">{{ $tripleBannerAd->title }}</h2>
            @endif
            <div class="bannerboard__wrapper bannerboard__wrapper--triple">
                @for ($i = 1; $i <= 3; $i++) @php $imageKey="image_$i" ; $image_url=$tripleBannerAd->$imageKey;
                    $alt_text = $tripleBannerAd->title . ' Item ' . $i;
                    @endphp
                    @if ($image_url)
                    <div class="bannerboard__board bannerboard__board--short"
                        data-analytics-asset-id="{{ $tripleBannerAd->id }}_{{ $i }}"
                        data-analytics-asset-type="BannerboardTripleItem" data-analytics-asset-position="{{ $i }}">

                        <a data-analytics-asset-link="{{ $tripleBannerAd->url }}" href="{{ $tripleBannerAd->url }}"
                            target="_blank">
                            <img alt="{{ $alt_text }}" class="bannerboard__image" src="{{ asset($image_url) }}"
                                onerror="this.onerror=null;this.src='https://placehold.co/333x200/CCCCCC/333333?text=Ad+Item+{{ $i }}'">
                        </a>
                    </div>
                    @endif
                    @endfor
...
<div class="component__wrapper component__wrapper--background-white">
    <section class="component component--duoboard duoboard" data-analytics-component-id="170590"
        data-analytics-component-type="Duoboard" data-js-component="Duoboard" data-js-scheduled-component-id="170590">
        <div class="component__content">
            <div class="duoboard__boards">
                ...
                <div class="duoboard__board duoboard__board--DuoboardShort" data-analytics-asset-id="83592"
                    data-analytics-asset-position="1" data-analytics-asset-type="DuoboardShort"><a
                        data-analytics-asset-link="#" href="#"><img alt="Your First Step To Riding - Learn More"
                            class="duoboard__image"
...
@if (isset($doubleBannerAd) && $doubleBannerAd)
<div class="component__wrapper component__wrapper--background-white">
    <section class="component component--duoboard duoboard" data-analytics-component-id="{{ $doubleBannerAd->id }}"
        data-analytics-component-type="Duoboard" data-js-component="Duoboard"
        data-js-scheduled-component-id="{{ $doubleBannerAd->id }}">

        <div class="component__content">
            @if ($doubleBannerAd->title)
            <h2 class="duoboard__section-title">{{ $doubleBannerAd->title }}</h2>
            @endif
            <div class="duoboard__boards">
                @for ($i = 1; $i <= 2; $i++) @php $imageKey="image_$i" ; $image_url=$doubleBannerAd->$imageKey;
                    $alt_text = $doubleBannerAd->subtitle ? $doubleBannerAd->subtitle : $doubleBannerAd->title . ' Ad '
                    . $i;
                    @endphp
                    @if ($image_url)
                    <div class="duoboard__board duoboard__board--DuoboardShort"
                        data-analytics-asset-id="{{ $doubleBannerAd->id }}_{{ $i }}"
                        data-analytics-asset-position="{{ $i-1 }}" data-analytics-asset-type="DuoboardShort">
                        <a data-analytics-asset-link="{{ $doubleBannerAd->url }}" href="{{ $doubleBannerAd->url }}"
                            target="_blank">
                            <img alt="{{ $alt_text }}" class="duoboard__image" src="{{ asset($image_url) }}"
                                onerror="this.onerror=null;this.src='https://placehold.co/500x300/CCCCCC/333333?text=Ad+Item+{{ $i }}'">
                        </a>
                    </div>
                    @endif
                    @endfor
...
=======
    ...
    <div class="component__wrapper">
        <section
            ...
            data-js-scheduled-component-id="173306">
            <div class="component__content">
                <div class="category-preview__miniboard category-preview__miniboard--mobile miniboard--dynamic-height"
                    data-asset-id="86021" data-asset-name="" data-asset-type="Miniboard">
                    <a class="category-preview__board  miniboard__board ui-cta-button-wrapper"
            ...
            <div class="component__content">
                <div class="bannerboard__wrapper">
                    <div class="bannerboard__board bannerboard__board--short bannerboard__board--mobile-left"
                        ...
                        data-analytics-asset-position="0">
                        <a data-analytics-asset-link="#" href="#" target="_blank"><img
                    ...
                    <section class="css-tabs tabbed-shop-your-ride__tabs" role="tablist">
                                ...
                                <span class="redline-tooltip" data-active="false" data-js="Tooltip.Container"><span
                                        class="redline-tooltip__icon" data-js="Tooltip.Icon"><span
                                            class="redline-tooltip__popout-window" data-js="Tooltip.PopoutWindow"><span
                                                class="redline-tooltip__tooltip-arrow"
                                                data-js="Tooltip.Arrow"></span><span
                        ...
                        <section class="css-tabs__panel" data-js="TabbedShopYourRide.bikeSelect">
                            ...
                            <div class="tabbed-shop-your-ride__mobile-garage-callout">
                                <div class="shop-by-bike__action-button shop-by-bike__action-button--mobile ui-action-button ui-action-button--cog ui-action-button--bold ui-action-button--dark"
                                    data-js="ShopByBike.garageFlyoutToggle ShopByBike.authedInterface"
                                    style="display: none">
                                    Garage
                        ...
                        <label data-qa="shop-by-vehicle-oem-tab" class="css-tabs__label js-SteppedShopYourRide-tabLabel"
                            for="oem-parts-152984-0" role="tab">
                            OEM Parts</span>
                            <span class="show-for-medium stepped-shop-your-ride__tooltip">
                                <span class="redline-tooltip" data-active="false" data-js="Tooltip.Container"><span
                                        class="redline-tooltip__icon" data-js="Tooltip.Icon"><span
                                            class="redline-tooltip__popout-window" data-js="Tooltip.PopoutWindow"><span
                                                ...
                                                equipment that came stock on your bike &amp; optional accessories
                                                available
                            ...
                            <div class="tabbed-shop-your-ride__form-wrapper">
                                <div class="shop-by-bike__form">
                                    <form class="shop-by-bike__select-dimensions" data-js="VehicleSelector.form"
                                        ...
                                        <input name="facet_ids" type="hidden" value="">
                                        <input name="suppress_oem_redirect" type="hidden" value="true">
                                        <input type="radio" id="shop-by-bike__type-step-0-oem"
                                            name="shop-by-bike__steps" class="ui-radio-button shop-by-bike__step-toggle"
                                            checked>
                                        <div class="shop-by-bike__step">
                                            <p class="shop-by-bike__label ui-copy">My vehicle is a…</p>
                                        ...
                                        <input type="radio" id="shop-by-bike__year-step-0-oem"
                                            name="shop-by-bike__steps"
                                            class="ui-radio-button shop-by-bike__step-toggle">
                                        <div class="shop-by-bike__step">
                                            <p class="shop-by-bike__label ui-copy">My vehicle&#39;s year is…</p>
                                        ...
                                        <input type="radio" id="shop-by-bike__make-step-0-oem"
                                            name="shop-by-bike__steps"
                                            class="ui-radio-button shop-by-bike__step-toggle">
                                        <div class="shop-by-bike__step">
                                            <p class="shop-by-bike__label ui-copy">My vehicle&#39;s make is…</p>
...
>>>>>>> 4c182987ded501b02deec36616d630990b82571f
<section aria-label="Shop by vehicle" class="component component--stepped-shop-your-ride stepped-shop-your-ride"
        ...
        <div class="shop-by">
            ...
            <div class="stepped-shop-your-ride__content-wrapper">
                ...
                <section class="css-tabs stepped-shop-your-ride__tabs" role="tablist">
                    <input class="css-tabs__input js-SteppedShopYourRide-tabToggle" name="tabs-152984-1" type="radio"
                        autocomplete="off" id="aftermarket-parts-152984-1" />
                    <label data-qa="shop-by-vehicle-aftermarket-tab"
                    ...
                    <input class="css-tabs__input js-SteppedShopYourRide-tabToggle" name="tabs-152984-1" type="radio"
                        autocomplete="off" id="oem-parts-152984-1" />
                    <label data-qa="shop-by-vehicle-oem-tab" class="css-tabs__label js-SteppedShopYourRide-tabLabel"
...
<section class="component component--bannerboard bannerboard" data-js-component="Bannerboard">
    ...
    <div class="component__content">
        <div class="bannerboard__wrapper">
            <a href="{{ $activeImageAd->link ?? '#' }}" class="ad-banner-link" target="_blank"
                rel="noopener noreferrer">
                <img {{-- FIX: Use asset() without the prefix --}} src="{{ asset($activeImageAd->image) }}"
                    alt="Ad banner image" class="ad-banner-image">
            </a>
        </div>
    </div>
=======
    ...
    <section class="component component--seo-block seo-block" data-analytics-component-id="167895"
        ...
        <div class="component__content">
            ...
            <div class="seo-block__top-content ui-copy-container ui-copy-container--small"
                ...
                <p>Bongshal is the largest online retailer of motorcycle gear, parts, and accessories in the U.S.
                    Founded
                    by riders in 2007, our team of motorcycle enthusiasts and product experts is dedicated to helping
                    you
                    ...
                    Bongshal? Fast &amp; reliable shipping, no restock fees on returns, expert video product reviews,
                    and
        ...
        w.__rq.push(function (req) {
            require(
                ...
                window.scheduledPage = new ScheduledPage(["PageData", "PageTitle", "Megaboard",
                    ...
                    "CategoryPreview", "Bannerboard", "Trioboard",
                    "ConfigurableCertonaTray",
